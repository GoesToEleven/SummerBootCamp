var ref = new Firebase("https://test-swbc-11-04-push.firebaseio.com/");
...
// set will replace all of the data at URL referenced by 'ref' variable
        ...
        "speakers": [
            {
                ...
                "bio": "Art is Richard’s third career. He is a Vietnam veteran"
            }
        ]
    });
});

var addAllNode = document.querySelector('#addAllNode');
addAllNode.addEventListener('click', function () {
    ref.set({
        "speakers": [
            {
